...
const DRUG_SVGS = {
    blister: (color = '#39B54A') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gb" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#1476BD" /></linearGradient></defs>
    ...
    capsBottle: (color = '#1476BD') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gc" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#39B54A" /></linearGradient></defs>
            <rect x="35" y="10" width="50" height="15" rx="4" fill="#637483" opacity="0.55" />
    ...
    syrupBottle: (color = '#D94B45') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gs" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#E89522" /></linearGradient></defs>
    ...
    creamTube: (color = '#1476BD') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gt" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#39B54A" /></linearGradient></defs>
    ...
    vitaminBot: (color = '#E89522') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gv" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#D94B45" /></linearGradient></defs>
    ...
    tonometer: (color = '#1476BD') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gtn" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#0D4F8B" /></linearGradient></defs>
    ...
    heartPill: (color = '#D94B45') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gh" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#0D4F8B" /></linearGradient></defs>
    ...
    gastroBot: (color = '#39B54A') => (
        <svg viewBox="0 0 120 100" width="72" height="60">
            <defs><linearGradient id="gg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor={color} /><stop offset="100%" stopColor="#208B3A" /></linearGradient></defs>
...
export default function DrugImage({ imageType, imageUrl, category, size = 72, fit = 'contain' }) {
    ...
    const color = CATEGORY_COLORS[category] || '#39B54A';
